...
function up_cuisine_add_form_fields() {
    ?>
        <div class = "form-field">
            ...
            <p> <?php _e("A URL the user can click on to get more information about this cuisine", "udemy-plus"); ?></p>
        </div>
    <?php
}
    ...
    ?>
        <tr class="form-field">
            ...
            <td>
                ...
                <p class ="description"> <?php _e("A URL the user can click on to get more information about this cuisine", "udemy-plus"); ?></p>            
            </td>
        </tr>
    <?php
}